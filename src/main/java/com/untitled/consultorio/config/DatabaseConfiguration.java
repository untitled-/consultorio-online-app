package com.untitled.consultorio.config;

import com.untitled.consultorio.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.untitled.consultorio.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.untitled.consultorio.repository.search")
