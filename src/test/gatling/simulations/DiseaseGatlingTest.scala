...
class DiseaseGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Disease entity")
        ...
        .repeat(2) {
            ...
            .post("/api/diseases")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "code":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "type":"SAMPLE_TEXT", "isCongenital":null, "isInfectious":null}""")).asJSON
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_disease_url")))
            .pause(10)
            .repeat(5) {
